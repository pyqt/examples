...
These PyQt examples teach you to create a desktop app with Python. Start with "[Hello World](src/01%20PyQt%20QLabel)" or browse the [official PyQt demos](#official-pyqt-demos). You can use Windows, Mac or Linux.
